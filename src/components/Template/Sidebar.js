...
const SideNav = () => { return <div id="sidebar-menu">
                <ul className="metismenu" id="side-menu">
                            ...
                            <li>
                                <Link to="pages-builder" className="waves-effect waves-light"><i className="ion ion-md-clipboard"></i><span> Builder </span></Link>
                            </li>
                            ...
                            <li>
                                <Link to="template-light-sidebar" className="waves-effect">
                                    <i className="ion ion-md-options"></i><span> Light Sidebar </span>
                                </Link>
                            </li>

                            <li>
                                <Link to="template-collapsed-sidebar" className="waves-effect">
...
const mapStatetoProps = state => {
    const { is_toggle } = state.template;
    return {  is_toggle };
}
